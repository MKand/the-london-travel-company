...
jq '{serialized_application_template: .serializedApplicationTemplate}' original-extract.json > ${SOURCE_APP_TEMPLATE}.json
...
gsutil -m cp -r ./${SOURCE_APP_TEMPLATE}.json gs://$BUCKET_NAME/templates/$SOURCE_APP_TEMPLATE/
